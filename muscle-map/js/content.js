...
export const MUSCLES = {
  ...
  // PLACEHOLDER — calibrate via ?calibrate (lateral hip / outer upper thigh).
  abductors: { name: 'Abductors', regions: [
    { view: 'front', poly: [[0.345,0.47],[0.40,0.475],[0.40,0.55],[0.355,0.55]] },
    { view: 'back', poly: [[0.35,0.455],[0.405,0.46],[0.405,0.54],[0.36,0.54]] }
  ] },
