...
// Single fixed muscle list (no difficulty tiers). Shapes calibrated via ?calibrate.
// Wrist flexors = anterior forearm, wrist extensors = posterior forearm (from the
// forearm calibration). Abductors = PLACEHOLDER pending calibration.

export const MUSCLES = {
  pectoralis: { name: 'Pectoralis', regions: [
    { view: 'front', poly: [[0.364,0.275],[0.369,0.241],[0.402,0.215],[0.438,0.212],[0.468,0.225],[0.485,0.263],[0.488,0.295],[0.466,0.312],[0.397,0.31]] },
    { view: 'front', poly: [[0.504,0.273],[0.524,0.23],[0.565,0.221],[0.606,0.219],[0.637,0.262],[0.631,0.295],[0.56,0.306],[0.518,0.304]] }
  ] },
  ...
  'wrist-flexors': { name: 'Wrist Flexors', regions: [
  ...
  'wrist-extensors': { name: 'Wrist Extensors', regions: [
  ...
  abductors: { name: 'Abductors', regions: [
    { view: 'front', poly: [[0.377,0.68],[0.402,0.676],[0.405,0.656],[0.391,0.625],[0.38,0.601],[0.377,0.569],[0.377,0.541],[0.377,0.523],[0.394,0.501],[0.397,0.465],[0.388,0.445],[0.377,0.439],[0.364,0.476],[0.347,0.526],[0.35,0.575],[0.355,0.625],[0.369,0.645]] },
    { view: 'front', poly: [[0.598,0.46],[0.609,0.447],[0.626,0.441],[0.626,0.475],[0.637,0.513],[0.637,0.556],[0.64,0.602],[0.631,0.645],[0.606,0.662],[0.593,0.662],[0.606,0.634],[0.62,0.589],[0.62,0.549],[0.609,0.513],[0.598,0.48]] }
  ] },
  'tibialis-anterior': { name: 'Tibialis Anterior', regions: [
  ...
  soleus: { name: 'Soleus', regions: [
    { view: 'back', poly: [[0.369,0.799],[0.399,0.882],[0.433,0.892],[0.449,0.817]] },
    { view: 'back', poly: [[0.543,0.814],[0.623,0.805],[0.584,0.888],[0.56,0.89]] }
  ] },
  rhomboids: { name: 'Rhomboids', regions: [
    { view: 'back', poly: [[0.438,0.284],[0.413,0.233],[0.369,0.234],[0.339,0.255],[0.339,0.266],[0.358,0.27],[0.358,0.284]] },
    { view: 'back', poly: [[0.56,0.286],[0.601,0.292],[0.626,0.282],[0.664,0.267],[0.637,0.24],[0.595,0.23],[0.579,0.23]] }
  ] },
  ...
  'gluteus-maximus': { name: 'Gluteus Maximus', regions: [
  ...
  gastrocnemius: { name: 'Gastrocnemius', regions: [
...
// Single fixed list — no difficulty tiers.
