...
export default function NeuralNetworkLabReview({ activity, studentMap }) {
        ...
        for (const sub of subs) {
          ...
          try {
            ...
            for (const courseDoc of coursesSnap.docs) {
              try {
                const gradeDoc = await getDoc(doc(db, "progress", uid, "courses", courseDoc.id, "activities", "neural-network-lab"));
                if (gradeDoc.exists()) {
                  existingGrades[uid] = {
