// seed-phys-u1-l05-voltage-current-power-v2.cjs — Unit 1 Lesson 5: voltage, current & power (light quantitative, PS3.B).
// Run: cd ~/pantherlearn-wt/openscied-u1-grid-sim && NODE_PATH=~/pantherlearn/node_modules node scripts/seed-phys-u1-l05-voltage-current-power-v2.cjs
