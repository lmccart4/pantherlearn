module.exports = {
  ...
  blocks: [
    ...
    },
    {
      ...
      url: '/printables/ai-literacy/unit5/law-defendant-scoring-worksheet.html',
      title: 'Printable: Defendant Scoring Worksheet',
      description: '1 page, B&W. 1 worksheet per student.',
