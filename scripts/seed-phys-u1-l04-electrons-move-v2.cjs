// seed-phys-u1-l04-electrons-move-v2.cjs — Unit 1 Lesson 4: current as moving charge (AC vs DC).
// Run: cd ~/pantherlearn-wt/openscied-u1-grid-sim && NODE_PATH=~/pantherlearn/node_modules node scripts/seed-phys-u1-l04-electrons-move-v2.cjs
...
const lesson = {
  ...
  blocks: [
    ...
    k.text(
      ...
      "**electric current**.\n\n" +
      "The drift is slow — in a typical household copper wire, electrons drift at roughly **1 mm/s**, about the speed of a " +
      "crawling ant. But the electrical *signal* that tells them to start moving travels close to the speed of light, " +
