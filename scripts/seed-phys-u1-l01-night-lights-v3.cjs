// seed-phys-u1-l01-night-lights-v3.cjs — Unit 1 Lesson 1: expanded anchor + pre-assessment + printable practice as graded blocks.
// Run: cd ~/pantherlearn-wt/openscied-u1-grid-sim && NODE_PATH=~/pantherlearn/node_modules node scripts/seed-phys-u1-l01-night-lights-v3.cjs
...
const lesson = {
  ...
  blocks: [
    ...
    k.sectionHeader({ icon: '📝', title: 'Practice: Reading the Numbers', subtitle: 'from the printable handout' }),

    k.mc({
      prompt: 'Which number from the Sandy report tells us how **widespread** the power outage was at its worst?',
      options: [
        'about 2.7 million homes and businesses lost power',
        'about 775,000 people were still without power one week later',
        'more than 93,000 trees had to be cut down',
        'more than 2,400 power poles had to be replaced',
      ],
      correctIndex: 0,
      explanation:
        'The peak outage number — about 2.7 million accounts — shows the maximum reach of the blackout at one time.',
      difficulty: 'understand',
    }),

    k.mc({
      prompt: 'Which number tells you the outage **lasted a long time**, not just that it was widespread?',
      options: [
        'about 2.7 million homes and businesses lost power',
        'about 775,000 people were still without power one week later',
        'more than 93,000 trees had to be cut down',
      ...
      correctIndex: 1,
      explanation:
        'One week after the storm, about 775,000 people were still in the dark. Most outages are fixed within hours or days, ' +
        'so a six-figure number after a week shows the damage was severe and long-lasting.',
      difficulty: 'understand',
    }),

    k.shortAnswer({
      prompt:
        'Perth Amboy has about **55,000** residents. About **775,000 people** were still without power one week after Sandy. ' +
        'In your own words, what does it mean that 775,000 is about **14 times** the population of Perth Amboy?',
      placeholder: 'If every person in Perth Amboy lost power, that would still be…',
      difficulty: 'understand',
    }),
  ],
};
