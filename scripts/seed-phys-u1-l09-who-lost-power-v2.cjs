// seed-phys-u1-l09-who-lost-power-v2.cjs — Unit 1 Lesson 9: equity & values in restoration (human endeavor).
// Robust expansion; run only after Claude review.
// Run: cd ~/pantherlearn-wt/openscied-u1-grid-sim && NODE_PATH=~/pantherlearn/node_modules node scripts/seed-phys-u1-l09-who-lost-power-v2.cjs
