...
// Creates "How TikTok Decides What You See (and What You Don't)" (Dig Lit, Algorithm Economy, Lesson 45)
...
const lesson = {
  ...
  blocks: [
    ...
    },
    {
      ...
      style: "question",
      icon: "❓",
      content: "**Question of the Day:** TikTok doesn't require you to follow anyone to give you a personalized feed. How does it figure out what you want before it knows anything about you?"
    },
    {
      id: "q-warmup",
      type: "question",
      questionType: "short_answer",
      prompt: "Have you ever had the experience of TikTok (or another algorithm) showing you something so specific to your interests or mood that it felt almost unsettling? Describe it.",
    ...
    },
    {
      ...
      style: "insight",
      icon: "💡",
      content: "**The test distribution system:** When a new video is posted, TikTok doesn't immediately show it to millions. It shows it to a small test group of ~100-500 people. If that group engages well (high completion rate, shares), it gets shown to a larger group. If that group engages, it expands further. This is why videos \"blow up\" — they passed progressively larger tests. A video with 10 views isn't dead — it just failed its first test."
    },
    {
      id: "q-weight",
      type: "question",
      questionType: "multiple_choice",
      prompt: "A TikTok video gets: 10,000 likes, 200 comments, 50 shares, and a 45% completion rate (average viewer watches less than half). Another video gets: 500 likes, 30 comments, 15 shares, and a 95% completion rate. Which video is TikTok's algorithm more likely to promote further?",
      options: [
    ...
    },
    {
      id: "b-summary",
      type: "text",
      content: "TikTok's algorithm is the most accurate interest-inference system ever deployed at consumer scale — and it works by watching behavior, not preferences.\n\nIt's also opaque. Users don't know exactly why they see what they see. Creators don't know exactly why their content gets promoted or suppressed. And regulators are still figuring out how to evaluate algorithms they can't see inside.\n\n**Up next:** Lesson 46 — Virality by Design. You've seen how the algorithm distributes content. Now: what makes content spread? Virality isn't luck — it follows patterns."
    },
    {
      id: "q-exit",
      type: "question",
      questionType: "short_answer",
      prompt: "Exit Ticket: Based on what you learned, what's one concrete action you could take to intentionally change what your TikTok (or other) algorithm shows you? Why would that specific action work, based on how the algorithm actually works?",
      placeholder: "Action: ...\nWhy it works: ...",
      difficulty: "apply"
    },
...
async function seed() {
  try {
    await db.collection("courses").doc("digital-literacy")
      .collection("lessons").doc("algorithm-tiktok")
      .set(lesson);
    console.log('✅ Lesson "How TikTok Decides What You See" seeded!');
