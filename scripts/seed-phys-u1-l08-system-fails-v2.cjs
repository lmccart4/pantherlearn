// seed-phys-u1-l08-system-fails-v2.cjs — Unit 1 Lesson 8: what physically failed during Sandy.
// Robust expansion; run only after Claude review.
// Run: cd ~/pantherlearn-wt/openscied-u1-grid-sim && NODE_PATH=~/pantherlearn/node_modules node scripts/seed-phys-u1-l08-system-fails-v2.cjs
