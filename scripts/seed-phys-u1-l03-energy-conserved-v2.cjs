// seed-phys-u1-l03-energy-conserved-v2.cjs — Unit 1 Lesson 3: conservation of energy + accounting for losses.
// Run: cd ~/pantherlearn-wt/openscied-u1-grid-sim && NODE_PATH=~/pantherlearn/node_modules node scripts/seed-phys-u1-l03-energy-conserved-v2.cjs
