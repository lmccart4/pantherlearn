// seed-phys-u1-l06-making-electricity-v2.cjs — Unit 1 Lesson 6: generators & electromagnetic induction (HS-PS2-5).
// Robust expansion; run only after Claude review.
// Run: cd ~/pantherlearn-wt/openscied-u1-grid-sim && NODE_PATH=~/pantherlearn/node_modules node scripts/seed-phys-u1-l06-making-electricity-v2.cjs
